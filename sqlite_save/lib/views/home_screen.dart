...
import 'package:state_lession/views/shared_preferenced_information.dart';
import 'package:state_lession/views/sqlite_data_screen.dart';
...
class _HomeScreenState extends State<HomeScreen> {
    ...
    return Scaffold(
        ...
        body: SingleChildScrollView(
            ...
            children: [
              ...
              ElevatedButton(
                  onPressed: (){
                    ...
                    Information information = Information(
                        ...
                        average_mark: averagePoint);
                    saveInformationIntoSQLiteDatabase(information: information);
              ...
              TextButton(
                  onPressed: (){
                    var route = MaterialPageRoute(builder: (context) => InformationScreen(averagePoint: averagePoint!, adjustmentResult: adjustmentResult!));
              ...
              TextButton(
                  onPressed: (){
                    var route = MaterialPageRoute(builder: (context) => SQliteDataScreen());
                    Navigator.push(context, route);
                  },
                  child: Text("Show SQLite Data")),
 ...
 saveInformationIntoSQLiteDatabase({required Information? information}) async {
  await  informationDatabase.addInformation(information);
 }
