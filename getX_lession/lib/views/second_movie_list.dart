...
class _SecondMovieListState extends State<SecondMovieList> {
  ...
  Widget build(BuildContext context) {
    ...
    // List<Movie> movieList  = movieListController.movieList;
    final MovieListObxController movieListObxController = Get.find();
    final  movieList  = movieListObxController.movieListObs.value;
