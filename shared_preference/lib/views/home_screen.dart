...
class _HomeScreenState extends State<HomeScreen> {
            ...
            children: [
              ...
              ElevatedButton(
                  onPressed: (){
                    ...
                    saveInformationToSharedPreference(
                        averageMark: averagePoint!, adjustment: adjustmentResult!);
              ...
              TextButton(
                  onPressed: (){
                    var route = MaterialPageRoute(builder: (context) => SharedPreferencedInformation());
                    Navigator.push(context, route);
                  },
                  child: Text("Show Shared Preferences Data")),
  ...
  saveInformationToSharedPreference({required double averageMark, required String adjustment}) async {
    final SharedPreferences prefs = await _prefs;
    print("Bắt đầu lưu vào Shared Preferences - Local Storage");
